...
# Form implementation generated from reading ui file 'D:\Dropbox\Dropbox\pw_pipeline\pw_pipeline\assets\houdini\python\VEX\pw_VEX_Editor\widgets\editor_window.ui'
#
# Created: Fri Oct 30 23:34:16 2015
...
class Ui_editor_window(object):
    def setupUi(self, editor_window):
        ...
        self.load_from_selected_btn = QtGui.QPushButton(self.frame)
        ...
        self.load_from_selected_extra_btn = QtGui.QPushButton(self.frame)
        ...
        self.load_from_file_btn = QtGui.QPushButton(self.frame)
        ...
        self.blank_tab_btn = QtGui.QPushButton(self.frame)
        ...
        self.save_current_btn = QtGui.QPushButton(self.frame)
        ...
        self.reload_current_btn = QtGui.QPushButton(self.frame)
        ...
        self.node_info_wd = QtGui.QWidget(self.frame)
        ...
        self.file_info_wd = QtGui.QWidget(self.frame)
        ...
        self.file_info_lb = QtGui.QLabel(self.file_info_wd)
        self.file_info_lb.setObjectName("file_info_lb")
        self.horizontalLayout_3.addWidget(self.file_info_lb)
        ...
        self.empty_wd = QtGui.QWidget(self.frame)
    ...
    def retranslateUi(self, editor_window):
        ...
        self.file_info_lb.setText(QtGui.QApplication.translate("editor_window", "<html><head/><body><p>File Path:<br/>c:/path/to/file.h</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
