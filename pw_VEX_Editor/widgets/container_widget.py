...
class Container(QWidget):
    ...
    def define_new_source(self):
        r = hou.ui.displayMessage('Where you want to save the code?', buttons=('File .h','Node parameter', 'HDA Section', 'Cancel'),
        ...
        if r == 0:
            path = hou.ui.selectFile('', 'Save .h file', False,hou.fileType.Any, '*.h',chooser_mode=hou.fileChooserMode.Write,)
            if path:
